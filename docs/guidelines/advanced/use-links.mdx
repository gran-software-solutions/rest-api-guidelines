...
Why is it so? Because you need to be able to fetch all the needed data
in order to build all the links. Additionally, we should not serve the links back to the client that's not authorized to execute them.
:::
